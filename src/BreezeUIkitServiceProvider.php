...
namespace Zacksmash\BreezeUIkit;

use Illuminate\Support\ServiceProvider;
use Zacksmash\BreezeUIkit\Commands\BreezeUIkitCommand;

class BreezeUIkitServiceProvider extends ServiceProvider
{
    public function boot()
    {
        if ($this->app->runningInConsole()) {
            ...
            ], 'breeze-uikit-resources');

            $this->commands([
                BreezeUIkitCommand::class,
            ]);
        }
    }
}
